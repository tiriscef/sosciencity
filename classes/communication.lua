...
[WarningType.insufficient_food_variety] = function(entry)
    ...
    [WarningType.on_strike] = function(caste_id)
        local caste = castes[caste_id]
        say_random_variant("warning-on-strike", nil, caste.localised_name_short, caste.localised_name)
    end,
