...
Biology.flora = {
    ...
    ["avocado"] = {
        ...
        growth_variance = {
            max_value = 1,
            min_value = 0.5,
            hold_time_max = 12 * Time.minute,
            slope_down_time = 2 * Time.minute,
            hold_time_min = 8 * Time.minute,
            slope_up_time = 2 * Time.minute,
    ...
    ["bell-pepper"] = {
        ...
        growth_variance = {
            max_value = 1,
            min_value = 0.5,
            hold_time_max = 6 * Time.minute,
            slope_down_time = Time.minute,
            hold_time_min = 4 * Time.minute,
            slope_up_time = Time.minute,
            time_offset = 2 * Time.minute
        },
        --preferred_climate = Climate.hot,
        --wrong_climate_coefficient = 0.8,
        --preferred_humidity = Humidity.moderate,
    ...
    ["blue-grapes"] = {
        ...
        growth_variance = {
            max_value = 1,
            min_value = 0.55,
            hold_time_max = 7 * Time.minute,
            slope_down_time = 2 * Time.minute,
            hold_time_min = 5 * Time.minute,
            slope_up_time = Time.minute,
            time_offset = 4 * Time.minute
        },
        --preferred_climate = Climate.temperate,
    ...
    ["birdsnake"] = {
        ...
        growth_variance = {
            max_value = 1,
            min_value = 0.75,
            hold_time_max = 8 * Time.minute,
            slope_down_time = 2 * Time.minute,
            hold_time_min = 3 * Time.minute,
            slope_up_time = Time.minute,
            time_offset = Time.minute
        },
        --preferred_climate = Climate.hot,
    ...
    ["lemon"] = {
        ...
        growth_variance = {
            ...
            min_value = 0.45,
            hold_time_max = 10 * Time.minute,
            slope_down_time = 3 * Time.minute,
            hold_time_min = 7 * Time.minute,
            slope_up_time = Time.minute,
            time_offset = 8 * Time.minute
        },
        --preferred_climate = Climate.hot,
    ...
    ["zetorn"] = {
        ...
        growth_variance = {
            max_value = 1,
            min_value = 0.5,
            hold_time_max = 11 * Time.minute,
            slope_down_time = 2 * Time.minute,
            hold_time_min = 9 * Time.minute,
            slope_up_time = 2 * Time.minute,
            time_offset = 10 * Time.minute
        },
        --preferred_climate = Climate.hot,
