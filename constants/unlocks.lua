...
Unlocks.by_item_aquisition = {
    ...
    [get_tech_name("endower-flower")] = "endower-flower",
    ...
    [get_tech_name("pocelial")] = "pocelial",
    [get_tech_name("potato")] = "potato",
    [get_tech_name("primal-quacker")] = "primal-quacker",
    [get_tech_name("pyrifera")] = "pyrifera",
    [get_tech_name("queen-algae")] = "queen-algae",
    [get_tech_name("razha-bean")] = "razha-bean",
    [get_tech_name("red-hatty")] = "red-hatty",
