...
Tirislib.RecipeGenerator.create {
    results = {
        {type = "item", name = "natural-sciences-faculty", amount = 1}
    },
    ingredients = {
...
Tirislib.Entity.create {
    ...
    minable = {mining_time = 0.5, result = "natural-sciences-faculty"},
    max_health = 200,
    ...
    crafting_speed = 1,
    crafting_categories = {"sosciencity-natural-sciences-faculty"},
    energy_usage = "60kW",
    energy_source = {
        type = "electric",
...
Sosciencity.configure_building("natural-sciences-faculty")
