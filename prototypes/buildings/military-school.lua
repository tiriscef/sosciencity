...
Tirislib.Entity.create {
    ...
    minable = {mining_time = 0.5, result = "military-school"},
    max_health = 200,
    ...
    crafting_speed = 1,
    crafting_categories = {"sosciencity-military-school"},
    energy_usage = "60kW",
    energy_source = {
        type = "electric",
...
Sosciencity.configure_building("military-school")
