...
Tirislib.RecipeGenerator.create {
    results = {
        {type = "item", name = "tech-institute", amount = 1}
    },
    ingredients = {
...
Tirislib.Entity.create {
    ...
    minable = {mining_time = 0.5, result = "tech-institute"},
    max_health = 200,
    ...
    crafting_speed = 1,
    crafting_categories = {"sosciencity-tech-institute"},
    energy_usage = "90kW",
    energy_source = {
        type = "electric",
...
Sosciencity.configure_building("tech-institute")
