...
Tirislib.RecipeGenerator.create {
    results = {
        {type = "item", name = "clockwork-mines", amount = 1}
    },
    ingredients = {
...
Tirislib.Entity.create {
    ...
    minable = {mining_time = 0.5, result = "clockwork-mines"},
    max_health = 200,
    ...
    crafting_speed = 1,
    crafting_categories = {"sosciencity-clockwork-mines"},
    energy_usage = "60kW",
    energy_source = {
        type = "electric",
...
Sosciencity.configure_building("clockwork-mines")
