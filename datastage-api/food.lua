...
--- @param food_def FoodDefinition? Food definition; looked up in constants/food.lua by prototype.name if nil
...
--- @param food_def FoodDefinition? Food definition; looked up in constants/food.lua by item_name if nil
